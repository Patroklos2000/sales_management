...
import output.SalesReportOutputHTML;
import output.SalesReportOutputTXT;
import output.SalesReportOutputXML;
...
public class SalesOutputWindow extends JDialog {
	...
	private ReceiptDataSelectionWindow selectionWindow;
	...
	public SalesOutputWindow(final ReceiptDataSelectionWindow sw, SalesReport agent,double tSales,int tItems,
	...
	private void initialise(){
		...
		}
		{
			...
			htmlReportButton.setBounds(436, 342, 163, 81);
		...
		btnNewButton.setBounds(146, 360, 101, 33);
		...
		btnNewButton_1.setBounds(257, 360, 101, 33);
	...
	private void outputTXTButtonPressed(ActionEvent evt) {
		...
		SalesReportOutputTXT makeTXTFile = new SalesReportOutputTXT(selectedAgent, recieptFileTXT);
	...
	private void outputXMLButtonPressed(ActionEvent evt) {
		...
		TXTFileChooser.setFileSelectionMode(JFileChooser.APPROVE_OPTION);		       
		TXTFileChooser.showOpenDialog(null);
		File recieptFileXML = TXTFileChooser.getSelectedFile();
		
		SalesReportOutputXML makeXMLFile = new SalesReportOutputXML(selectedAgent, recieptFileXML);
	...
	private void outputHTMLButtonPressed(ActionEvent evt) {
		...
		SalesReportOutputHTML makeHTMLFile = new SalesReportOutputHTML(selectedAgent, recieptFileHTML);
